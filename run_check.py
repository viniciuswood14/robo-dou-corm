...
async def main_loop():
    ...
    # ... dentro do while True, logo após as verificações de DOU/Valor/PAC ...

            # 4. LEGISLATIVO (Rodar a cada 60 min ou horário fixo)
            # Vamos usar uma lógica simples: se o minuto for 30 (ex: 08:30, 09:30...)
            # e ainda não tiver rodado nessa hora.
